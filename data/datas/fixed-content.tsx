...
const fixedContent = {
  home: {
    introduction: {
      ...
      text: (
        <>
          Foxylib is an open-source library of UI components based on Tailwind
          CSS framework.
          <br />
          ...
          <br />
          All of the elements are built using the utility classes from Tailwind
          CSS and Next.Js.
        </>
      ),
      tailwind: "Tailwind CSS 3.0",
      textTailwind:
        "Feel free to upgrade to version 3 of Tailwind CSS as there are no breaking changes when using the components from Foxylib.",
    },
  },
  tabs: [
